            ...
            if (!g.a(context)) {
                ...
                this.g.scheduleAtFixedRate(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (PatchProxy.isSupport(objArr, this, changeQuickRedirect, false, "c3d52b517dcbdf232c6179a489581d69", 4611686018427387904L)) {
                            PatchProxy.accessDispatch(objArr, this, changeQuickRedirect, false, "c3d52b517dcbdf232c6179a489581d69");
                            return;
                        }
